...
TODO: explain make more?  here or elsewhere
...
visualize:
  ...
  -
    ...
    alttext: "figure displaying discharge of Cuyahoga river"
```
In the visualize step, `location` specifies the location of the figure being output by each step.  
...
publish:
  -
    ...
    publisher: page
    template: fullPage
    depends: [ "cars-section", "figure-style", "iris-section", "relativeAbundance-section"]
    context:
      title: Testing
      sections: [ "cars-section", "iris-section", "relativeAbundance-section"]
...
TODO: timestamps, Controlling refetch options, debugging?
