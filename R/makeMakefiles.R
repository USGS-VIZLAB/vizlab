...
#'   
#' @export
makeMakefiles <- function(blocks=c('fetch','process','visualize'), display=FALSE) {
  makefiles <- c(
...
makeMakeRunmakeRules <- function() {
  ...
  # from viz.yaml
  blocks <- c('fetch','process','visualize')
...
#'   
#' @export
makeBlockMakefile <- function(block=c('fetch','process','visualize'), outfile) {
...
#'   
#' @export
makeMakeBlockRules <- function(block=c('fetch','process','visualize')) {
  block <- match.arg(block)
