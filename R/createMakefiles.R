...
#'
#' @export
createMakefiles <- function(blocks=c('global','fetch','process','visualize', 'publish'), display=FALSE) {
  makefiles <- c(
...
createShortcuts <- function(){
  blocks <- c('global','fetch','process','visualize','publish')
...
#'
#' @export
createBlockMakefile <- function(block=c('global','fetch','process','visualize','publish'), outfile) {
...
#'
#' @export
createMakeBlockRules <- function(block=c('global','fetch','process','visualize','publish')) {
  block <- match.arg(block)
...
#' \code{createMakeItem.global}: create makefile rules for an item in the
#' global block of viz.yaml
#'
#' @rdname createMakeItem
#' @export
